<?php
// script pour supprimer les items dans les paniers
...
$key = array_search($product_id, $array); // si on appuie sur le bouton pour supprimer
if ($key !== false) {                    // alors on supprimer l'items sélectionner
    unset($array[$key]);
}
